...
#define MRET(mstatus) do { if((mstatus & MPIE_MASK) == 0) { mstatus &= ~MIE_MASK; } else { mstatus |= MIE_MASK; } mstatus |= MPIE_MASK; } while(0)
  ...
  INSTPAT("????010 00000 ????? 001 ????? 11100 11", csrrw  , C, CSRRW(cpu.csr.mscratch));
  ...
  INSTPAT("????010 00000 ????? 010 ????? 11100 11", csrrs  , C, CSRRS(cpu.csr.mscratch));
  ...
  INSTPAT("????010 00000 ????? 011 ????? 11100 11", csrrc  , C, CSRRC(cpu.csr.mscratch));
  ...
  INSTPAT("????010 00000 ????? 101 ????? 11100 11", csrrwi , C, CSRRWI(cpu.csr.mscratch));
  ...
  INSTPAT("????010 00000 ????? 110 ????? 11100 11", csrrsi , C, CSRRSI(cpu.csr.mscratch));
  ...
  INSTPAT("????010 00000 ????? 111 ????? 11100 11", csrrci , C, CSRRCI(cpu.csr.mscratch));
