...
#define MUL_S(src1, src2) ((sdword_t)src1 * (sdword_t)src2)  
#define MUL_U(src1, src2) ((dword_t)src1 * (dword_t)src2)
  ...
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , r, R(dest) = BITS(MUL_S(src1, src2), 31, 0));
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , r, R(dest) = BITS(SEXT(src1, 32) * SEXT(src2, 32), 63, 32));
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , r, R(dest) = BITS(MUL_S(src1, BITS(src2, 31, 0)), 63, 32));
